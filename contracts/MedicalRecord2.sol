...
//     function setDoctorDetails(bool _state,address _drId,uint256 _num,string memory _name,string memory _qual,string memory _hosp) public OnlyOwner {
...
//     uint256[] drPhn;
//     string[] hospName;
//     function getDocbyName__mod(string memory _name) public  returns(address[] memory _dr_id, uint256[] memory _dr_phn,string[] memory  _hospN)  {
...
//     }
//     function getDocbyName() public view returns(address[] memory _dr_id, uint256[] memory _dr_phn,string[] memory _hosp){
//         return (drAddr,drPhn,hospName);
//     }


//     // Function to get Doctor details for admin
//     function getDoctorDetails(address _Id) public OnlyOwner view returns(bool _state,address _drId,string memory _name, uint256 _num , string memory  _qual,string memory _hosp ){
...
//     function getDoctorDetailsForDoc(address _Id) public Only_Doctors view returns(bool _state,address _drId,string memory _name, uint256 _num , string memory  _qual,string memory _hosp  ){
//         _state = DoctorInfo[_Id].state;
//         _drId = DoctorInfo[_Id].dr_Id;
//         _name = DoctorInfo[_Id].d_Name;
//         _num=DoctorInfo[_Id].dr_Phn;
...
//     function getPatientDetails(address _Id) public view returns(bool _state,address _paId,uint256 _paphn,string memory _paName,string[] memory _paRecords,string[] memory _paFiles){
...
//     address[] paAddr;
//     uint256[] paNum;
//     function getPatientbyName_mod(string memory _name) public  returns(address[] memory _dr_id , uint256[] memory _dr_phn){
...
//         return (paAddr,paNum);
//     }
//     function getPatientbyName() public view returns(address[] memory _pa_id, uint256[] memory _pa_phn){
//         return (paAddr,paNum);
//     }
