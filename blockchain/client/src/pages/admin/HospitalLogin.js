    ...
    return (
      <>  
       ...
       <p className="text-4xl">Hello..   {account}</p>
        ...
        <form className="shadow-2xl bg-slate-100 rounded-xl p-8 dark:bg-slate-800"  style={{backgroundColor: "white", width:"30%"}} >
            ...
            <div className="mb-3">
              ...
              <p><b>Name</b>           :  Demo</p>
              <p>id :           :  1234567</p>
              <p>Phone Number   :  9012345678</p>
              <p>Location       :  Hyderabad</p>
              <p>Public Address :  {account}</p>
              <p>email          :  demo_1@gmail.com</p>
            </div><br></br>
